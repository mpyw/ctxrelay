// Package zerologchecker provides SSA-based analysis for zerolog context propagation.
//
...
//   - checker.go : Entry point and checker (this file)
//   - tracer.go  : Strategy pattern tracers for Event/Logger/Context
//   - trace.go   : SSA value tracing implementation
//   - types.go   : Type checking and constants
...
// =============================================================================
// Ignore Map (passed from parent package)
// =============================================================================

// IgnoreMap tracks line numbers that should be ignored.
type IgnoreMap interface {
	ShouldIgnore(line int) bool
}
