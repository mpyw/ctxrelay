...
type API struct {
	...
	// TaskConstructor defines how to trace a task back to its callback.
	// Used by:
	// - CallArgPattern: to trace task args (DoAll) back to NewTask
	// - TaskSourcePattern: to trace task receiver (DoAsync) back to NewTask
